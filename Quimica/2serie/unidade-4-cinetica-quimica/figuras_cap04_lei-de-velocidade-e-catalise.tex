...
\begin{tikzpicture}[x=1cm,y=1cm,>=Latex]
  ...
  \foreach \x/\h/\lab/\txt in {1/1/0/nao muda,3/2/1/dobra,5/3/2/quadruplica}{
    \draw[fill=blue!15,very thick] (\x,0) rectangle +(0.8,\h);
    \node[below] at (\x+0.4,-0.08) {$\lab$};
    \node[above,align=center] at (\x+0.4,\h+0.1) {\txt};
  }
  \node[align=center] at (3.1,-0.8) {quando a concentracao dobra\\o efeito depende da ordem experimental};
\end{tikzpicture}
\end{document}
