...
Em uma estrada do interior paulista, há uma árvore baixa e retorcida que pode parecer frágil ao lado de uma árvore alta da floresta. Mas a aparência engana. Aquela forma "esquisita" conversa com meses de seca, solo ácido, raízes profundas e fogo natural. O Cerrado não é defeito de floresta — é um sistema completo, com regras próprias. E o mesmo vale para cada um dos seis biomas brasileiros.

> 💭 **Pense um pouco:** Quando você olha uma paisagem natural, que pistas mostram que aquele ambiente tem uma lógica própria?
...
Em um bioma saudável, esses quatro elementos não são listas soltas — eles "conversam" entre si. O clima determina o tipo de planta que cresce; a planta dá abrigo e alimento à fauna; o solo guarda os nutrientes que voltam para as raízes pelas folhas que caem. Quebrar um elemento afeta os outros.

> 🔬 **Ciência do Dia a Dia:** Quando uma árvore alta é derrubada na floresta densa, o solo recebe muito mais sol e chuva direta — e as plantas adaptadas à sombra podem desaparecer ali.

---

## 2. Florestas E Savanas Brasileiras

Três biomas entram nesse grupo: a Amazônia, o Cerrado e a Mata Atlântica.
...
O solo, surpreendentemente, é pobre em nutrientes: a maior parte da fertilidade está acumulada nas próprias árvores e nas folhas que caem. Por isso a Amazônia perde funções ecológicas inteiras quando grandes áreas são derrubadas.
...
- **Cerrado** — savana com seca, raízes profundas, casca grossa.
- **Mata Atlântica** — floresta costeira, endêmica, fragmentada.
...
Cada um responde a uma combinação única de clima, solo, flora e fauna. Não há bioma melhor ou pior: há sistemas diferentes funcionando com regras próprias.
