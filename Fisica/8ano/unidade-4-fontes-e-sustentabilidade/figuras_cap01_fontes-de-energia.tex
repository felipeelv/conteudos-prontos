...
\begin{tikzpicture}[>=Latex,node distance=0.9cm]
  ...
  \node[box,fill=gray!15,below=1.0cm of uso] (naoren) {não renovavel\\estoque finito};
...
\begin{tikzpicture}[x=0.11cm,y=0.22cm,>=Latex]
  ...
  \node[align=center,above] at (42,23) {Exemplo: matriz elétrica brasileira renovavel em 2023};
