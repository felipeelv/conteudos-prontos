...
\begin{tikzpicture}[>=Latex,node distance=2.2cm]
  ...
  \node[state,fill=cyan!10,right=of s] (l) {liquido\\agua};
  ...
  \node[align=center,above=0.75cm of l] {ganha energia para ir a direita\\perde energia para voltar};
\end{tikzpicture}
...
\begin{tikzpicture}[x=1cm,y=0.75cm,>=Latex]
  ...
  \node[align=center,right] at (6.2,4.3) {agua\\aquece};
