...
\begin{tikzpicture}[scale=0.78,>=Latex]
  ...
  \node[align=center] at (0,-2.8) {quanto maior a distancia media, maior o periodo orbital};
\end{tikzpicture}
...
\begin{tikzpicture}[>=Latex,node distance=1cm]
  ...
  \node[align=center,below=0.45cm of lei] {Kepler relaciona periodo e distancia media};
\end{tikzpicture}
