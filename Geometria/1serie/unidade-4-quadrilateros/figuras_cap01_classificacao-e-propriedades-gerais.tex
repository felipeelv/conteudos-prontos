...
\node at (4,4.05) {quadrilátero};
\draw[thick] (.5,.4) rectangle (7.5,3.55);
\node at (4,3.25) {trapézio};
\draw[thick] (1,0.8) rectangle (7,2.8);
\node at (4,2.5) {paralelogramo};
\draw[thick] (1.4,1.1) rectangle (3.8,2.1);
\node at (2.6,1.9) {retângulo};
\draw[thick] (4.2,1.1) rectangle (6.6,2.1);
\node at (5.4,1.9) {losango};
\draw[thick,fill=gray!12] (3.2,1.15) rectangle (4.8,1.7);
\node at (4,1.425) {quadrado};
\end{tikzpicture}
\end{document}
