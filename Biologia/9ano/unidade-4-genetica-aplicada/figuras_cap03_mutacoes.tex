...
\begin{tikzpicture}[>=Latex,node distance=0.7cm]
  ...
  \node[box,fill=yellow!18,below left=0.9cm and 0.2cm of dna] (sub) {substituicao\\A T G G A};
  \node[box,fill=orange!12,below=0.9cm of dna] (ins) {insercao\\A T C C G A};
  \node[box,fill=red!10,below right=0.9cm and 0.2cm of dna] (del) {delecao\\A T G A};
