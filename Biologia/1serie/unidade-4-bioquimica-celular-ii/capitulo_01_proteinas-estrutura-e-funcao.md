# Capítulo 1 — Proteínas: Estrutura e Função

## Como uma sequência de aminoácidos pode virar músculo, enzima, anticorpo ou cabelo?

Um fio de cabelo, uma fibra muscular e um anticorpo parecem materiais muito diferentes. Mesmo assim, todos dependem de proteínas formadas por aminoácidos. A diferença está na sequência, na dobra e na função que surge da forma. Em Biologia, a estrutura não é detalhe: muitas vezes, ela é a própria explicação da função.

> 💭 **Pense um pouco:**\
> O que muda mais uma proteína: trocar uma peça da sequência ou mudar a forma final dela?

![TikZ 1 — Níveis de organização das proteínas](https://raw.githubusercontent.com/felipeelv/conteudos-prontos/main/Biologia/1serie/unidade-4-bioquimica-celular-ii/figuras/cap01_tikz-1.png)
...
- enzimas com sítio ativo específico;
...
Entender proteínas ajuda a compreender alimentação, doenças, medicamentos e biotecnologia. A mesma lógica estrutural aparece do prato ao laboratório.
