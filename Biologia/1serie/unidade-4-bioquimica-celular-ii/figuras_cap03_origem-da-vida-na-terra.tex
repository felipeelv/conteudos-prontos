...
\begin{tikzpicture}[>=Latex,node distance=0.75cm]
  ...
  \node[box,fill=green!12,right=0.8cm of terra] (mol) {moléculas\\orgânicas};
  ...
  \node[align=center,below=0.65cm of mol] {hipóteses investigam mecanismos; propósito é uma pergunta teológica};
\end{tikzpicture}
\end{document}
