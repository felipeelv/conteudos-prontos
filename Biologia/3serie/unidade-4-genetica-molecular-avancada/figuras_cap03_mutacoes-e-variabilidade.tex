...
\begin{tikzpicture}[>=Latex,node distance=0.75cm]
  ...
  \node[box,fill=orange!12,right=0.9cm of reparo] (fixa) {mutação\\persistente};
  ...
  \node[align=center,below=0.35cm of reparo] {interpretar variante não é o mesmo que prever destino};
\end{tikzpicture}
\end{document}
